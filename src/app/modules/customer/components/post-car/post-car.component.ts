...
selectedFile: File|null;
 constructor(private service:CustomerService, private router:Router,  private fb: FormBuilder, private storage: StorageService){} 
// List of car brands
...
saveCarForm(){
  ...
  formData.append("userId", this.storage.getUserId());
