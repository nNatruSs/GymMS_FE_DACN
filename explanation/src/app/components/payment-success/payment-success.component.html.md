# Explanation: `src/app/components/payment-success/payment-success.component.html`

## File Overview
- **Relative path:** `src/app/components/payment-success/payment-success.component.html`
- **Total lines:** `19`
- **Non-empty lines:** `18`
- **Import statements:** `0`
...
| 4 | `      <div class="result-icon success mb-2">&#10003;</div>` | Declares a core TypeScript structure used by this module. |
| 5 | `      <h4 class="mb-2">Payment Successful</h4>` | Declares a core TypeScript structure used by this module. |
| 6 | `      <p class="text-muted mb-3">` | Declares a core TypeScript structure used by this module. |
| 7 | `        Your payment was completed successfully.` | Core implementation line contributing to the file behavior. |
...
| 14 | `        <a class="btn btn-primary btn-sm" routerLink="/user/dashboard/bookings/history">View Bookings</a>` | Declares a core TypeScript structure used by this module. |
